...
class UsersModel extends Model
{
    ...
    protected $allowedFields    = ['nik', 'no_kk', 'nama', 'status', 'jenis_kelamin', 'tempat_lahir', 'tgl_lahir', 'usia', 'status_perkawinan', 'pendidikan', 'email', 'password', 'role', 'foto', 'status_akun',  'created_at', 'updated_at'];
