...
<head>
  ...
  <!-- title -->
  <title>Form Tambah Pelaporan | Warga Site</title>
</head>
  ...
  <div>
    ...
    <main>
      <section class="container container-space pt-3">
        <form class="card-form-container card shadow" id="reportFormAdd" action="#" enctype="multipart/form-data" method="POST">
          <!-- header -->
          <div class="card-header">
            <p class="mb-0">Form Pelaporan</p>
          </div>
          <!-- body -->
          <div class="card-form-container card-body">
            <div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea id="deskripsi_laporan" name="deskripsi_laporan" class="form-control input-control" placeholder="Masukkan Deskripsi Laporan" required></textarea>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-footer">
            <div class="w-100 d-flex justify-content-end">
              <button type="submit" form="reportFormAdd" class="btn btn-main btn-submit" id="reportFormAddButton">
                Kirim
              </button>
            </div>
          </div>
