...
<html lang="en">
  <head>
    ...
    />
    <!-- title -->
    <title>Menu Keluarga | Warga Site</title>
  </head>
  <body>
    <div>
      <!-- navigation -->
          ...
          <div class="card-table-container shadow">
            ...
            <div class="table-container">
              <div class="table-responsive">
                <table
                  id="tableFamily"
                  class="table table-custom w-100"
                >
                      ...
                      <td>
                        <div class="dropdown dropdown-table pe-3">
                          ...
                          <ul class="dropdown-menu dropdown-menu-table shadow">
                            <li>
                              <a
                                class="dropdown-item dropdown-table-item"
                                href="./family-form-edit.html"
    ...
    <script>
      $(document).ready(function () {
        ...
        $('#tableFamily').dataTable({
          ...
          dom:
            "<'row pb-2'<'col-12 col-md-5 mb-3 mb-md-0'f><'col-12 col-sm-6 col-md-2 pl-md-0 mb-3 mb-sm-0'l>>" +
            "<'row'<'col-sm-12'tr>>" +
