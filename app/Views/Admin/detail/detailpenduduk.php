                        ...
                        <div class="card-body">
                            <div class="form-group form-show-validation row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-8">
                                    <input type="text" class="form-control" placeholder="Pilih Nomor Kartu Keluarga" id="no_kk" name="no_kk" value="<?= $dataPenduduk['no_kk'] ?>" disabled>
                                </div>
                            </div>
                            <div class="form-group form-show-validation row">
                            ...
                            <div class="form-group form-show-validation row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-8">
                                    <input type="text" class="form-control" id="agama" name="agama" disabled placeholder="-" value="<?= $dataPenduduk['agama'] ?>">
                                </div>
                            </div>
                            <div class="form-group form-show-validation row">
