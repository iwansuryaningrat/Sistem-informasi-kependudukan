...
function legendClickCallback(e) {
    ...
    n.legend.options.onClick.call(n, e, n.legend.legendItems[r]),
...
$(".nav-search .input-group > input")
    ...
    $(document).ready(function () {
        ...
        if (!c && $(".sidenav-toggler").length) {
            (w = $(".sidenav-toggler")).on("click", function () {
                ...
                $(".wrapper").mouseup(function (e) {
                    var a = $(".nav-bottom");
                    e.target.className == a.attr("class") ||
            ...
            k.on("click", function () {
                1 == p
                    ? ($("html").removeClass("topbar_open"),
                        ...
                        (p = 0))
                    : ($("html").addClass("topbar_open"), k.addClass("toggled"), (p = 1));
            }),
                (g = !0);
        }
        if (!m) {
        ...
        $(".wrapper").hasClass("is-show") &&
            ((C = 1),
                q.addClass("toggled"),
                q.html('<i class="icon-options-vertical"></i>')),
            q.on("click", function () {
                1 == C
                    ? ($(".wrapper").removeClass("is-show"),
                        q.removeClass("toggled"),
                        q.html('<i class="icon-menu"></i>'),
                        (C = 0))
