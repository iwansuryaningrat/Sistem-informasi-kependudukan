    ...
    "undefined" == typeof Chart
        ...
        : ((t.prototype.beforeDatasetsUpdate = function (t) {
            ...
            (t.prototype.afterDatasetsDraw = function (t) {
                this.parseOptions(t) &&
                    ((this.labelBounds = []),
                        t.config.data.datasets.forEach(this.drawDataset));
            }),
            (t.prototype.drawDataset = function (t) {
                for (
                    var e = this.ctx,
                    i = this.chartInstance,
                    o = t._meta[Object.keys(t._meta)[0]],
                    a = 0,
                    s = 0;
                    s < o.data.length;
                    s++
                    ...
                    if (0 !== n.circumference || this.showZero) {
                        switch (this.render) {
                            ...
                            default:
                                ...
                                (l = parseFloat(l.toFixed(this.precision))),
                        ...
                        if (
                            (e.save(),
                                ...
                                ("border" === this.position && "pie" === i.config.type))
                        ) {
                            var f,
                                c = n.outerRadius / 2,
                                p = this.fontSize + 2,
                            ...
                            if (
                                ("border" === this.position
                                    ? (f = (n.outerRadius - c) / 2 + c)
                                    : "outside" === this.position &&
                                    (f = n.outerRadius - c + c + p),
                                    (d = { x: n.x + Math.cos(d) * f, y: n.y + Math.sin(d) * f }),
                                    "outside" === this.position)
                            ) {
                        ...
                        if (
                            ("function" == typeof (p = this.fontColor)
                                ? (p = p({
                                    label: i.config.data.labels[s],
                                    value: t.data[s],
                                    percentage: l,
                                ...
                                : "string" != typeof p &&
                                (p = p[s] || this.options.defaultFontColor),
                                this.arc)
                        )
                            u || (u = (c + n.outerRadius) / 2),
                                (e.fillStyle = p),
                                (e.textBaseline = "middle"),
                                this.drawArcText(h, u, n, this.overlap);
                        else {
                            (c = this.measureText(h)),
                                (n = d.x - c.width / 2),
                                (c = d.x + c.width / 2);
            ...
            (t.prototype.parseOptions = function (t) {
                ...
                return (
                    ...
                    ((this.chartInstance = t),
                        (this.ctx = t.chart.ctx),
                        (this.options = t.config.options),
                        (this.render = e.render || e.mode),
                        (this.position = e.position || "default"),
                        (this.arc = e.arc),
                        (this.format = e.format),
                        (this.precision = e.precision || 0),
                        (this.fontSize = e.fontSize || this.options.defaultFontSize),
                        (this.fontColor = e.fontColor || this.options.defaultFontColor),
                        (this.fontStyle = e.fontStyle || this.options.defaultFontStyle),
                        (this.fontFamily = e.fontFamily || this.options.defaultFontFamily),
                        (this.hasTooltip = t.tooltip._active && t.tooltip._active.length),
                        (this.showZero = e.showZero),
                        (this.overlap = e.overlap),
                        (this.images = e.images || []),
                        (this.showActualPercentages = e.showActualPercentages || !1),
                        !0)
                );
            }),
            (t.prototype.checkTextBound = function (t, e, i, o) {
                for (var a = this.labelBounds, s = 0; s < a.length; ++s) {
                    for (
                        ...
                        var l = n[h][0],
                            f = n[h][1];
                        if (l >= r.left && l <= r.right && f >= r.top && f <= r.bottom)
                            return !1;
                    }
                    for (
                        n = [
            ...
            (t.prototype.fillText = function (t, e, i) {
                ...
                "object" == typeof t
                    ...
                    : ((o.fillStyle = i),
                        (o.textBaseline = "top"),
                        (o.textAlign = "center"),
                        o.fillText(t, e.x, e.y - this.fontSize / 2));
            }),
            ...
            (t.prototype.drawArcText = function (t, e, i, o) {
                ...
                if (
                    ((n +=
                        ((i += Math.PI / 2) - ((s = this.measureText(t)).width / e + n)) /
                        2),
                        o || !(i - n > r))
                )
                    if ("string" == typeof t)
                        for (a.rotate(n), o = 0; o < t.length; o++)
                            (n = t.charAt(o)),
                                (s = a.measureText(n)),
                                a.save(),
                                a.translate(0, -1 * e),
